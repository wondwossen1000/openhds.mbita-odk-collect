...
public class PreferencesActivity extends PreferenceActivity implements
    ...
    public static String VALIDATION_KEY_SERVER_ENABLED = "validationenabled";
    public static String VALIDATION_KEY_SERVER = "validationserver";
    public static String VALIDATION_KEY_USERNAME = "validationusername";
    public static String VALIDATION_KEY_PASSWORD = "validationpassword";
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(KEY_PROTOCOL)) {
            ...
            updatePassword(OPENHDS_KEY_PASSWORD);
	    } else if (key.equals(VALIDATION_KEY_SERVER_ENABLED)) {
	        updateValidation();
	    } 
    }
	...
	private void updateServer(String server) {
        EditTextPreference etp =
            (EditTextPreference) this.getPreferenceScreen().findPreference(server);
    ...
    private void updateUsername() {
       ...
       private void updateUsername(String username) {
        EditTextPreference etp =
            (EditTextPreference) this.getPreferenceScreen().findPreference(username);
    ...
    private void updatePassword() {
       ...
       private void updatePassword(String password) {
        EditTextPreference etp =
            (EditTextPreference) this.getPreferenceScreen().findPreference(password);
        etp.setText(etp.getText());
    }
    
        private void updateValidation() {
    	CheckBoxPreference pref = (CheckBoxPreference) getPreferenceScreen().findPreference(VALIDATION_KEY_SERVER_ENABLED);
